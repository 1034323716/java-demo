 ...
 *
 * 缺陷是：1000万个数字都小于1000万。改进：SELECT_TOP_NUM = 数组中最大的数字 / 32 + 1
 * 位图思想：int = 4字节 = 32位，每一位表示一个数字，表示的数字：数组下标×32+第几位
 * 遍历数组将每个值进入位图，倒序找最大的
 *
 * @author zhangxu04
 */
...
//    private static final int ARRAY_LENGTH = 10000000; // big array length
    private static final int ARRAY_LENGTH = 10; // big array length
    private static final int SELECT_TOP_NUM = 5; // big array length
...
//        int[] array = new int[]{1,2,11,22,132,5,8,9,4321,12};
    ...
    private void findTop100(int[] arr) {
        ...
        add(arr);
        int[] result = new int[SELECT_TOP_NUM];
        int index = 0;
